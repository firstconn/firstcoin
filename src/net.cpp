...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FirstCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.firstcoin.club", "108.179.227.118"},
	{"seed2.firstcoin.club", "108.179.227.119"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"test", "192.168.200.100"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FirstCoin is probably already running."), addrBind.ToString().c_str());
        else
