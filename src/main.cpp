...
#if defined(NDEBUG)
# error "FirstCoin cannot be compiled without assertions."
#endif
...
int64 CTransaction::nMinTxFee = 100;
...
const string strMessageMagic = "FirstCoin Signed Message:\n";
...
{
    // FirstCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // FirstCoin: 3.5 days
static const int64 nTargetSpacing = 1 * 60; // FirstCoin: 60 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // FirstCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FirstCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // FirstCoin: increase each by adding 2 to bitcoin's value.
